# The dynamics family, tasks

Dependency order. Each task lands with its requirement, its gate and its docs in one commit.
...
| The family selector and per-family artifact loading | R-209 | todo |
| The browser integrator and its parity gate | R-210 | todo |
| The sixteen workbench methods | R-211, R-212 | todo |
| The document pages read per family | R-209 | todo |
| Docs: methodology page, corpus table, guides | R-213 | todo |
| Release, deploy, live gate | all | todo |

## Convergence

Recorded here when the vertical closes: every requirement, its gate, the gate's result.
